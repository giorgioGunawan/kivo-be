...
const processJob = async (job) => {
    ...
    try {
        ...
        let result = null;
        let attempts = 0;
        const maxAttempts = 300; // 10 minutes (300 * 2s) - AI's can be slow!
        ...
        // If it's a Timeout or other internal error, mark as failed and refund
        await db.query(
        ...
        throw error; // Let BullMQ retry for network blips (unless it's already failed in DB)
    }
};
